...
-- Volcando datos para la tabla gdp_bd.cargo: ~0 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `intermedia_procesos` (
  ...
  `id_proceso_padre` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_proceso`,`id_proceso_padre`),
  KEY `id_proceso_padre` (`id_proceso_padre`),
  CONSTRAINT `intermedia_procesos_ibfk_1` FOREIGN KEY (`id_proceso`) REFERENCES `procesos` (`id_proceso`),
  CONSTRAINT `intermedia_procesos_ibfk_2` FOREIGN KEY (`id_proceso_padre`) REFERENCES `procesos` (`id_proceso`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;
...
-- Volcando datos para la tabla gdp_bd.procesos: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla gdp_bd.roles: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla gdp_bd.usuarios: ~0 rows (aproximadamente)
